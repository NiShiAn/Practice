...
(function(e) {
     e.fn.dragsort = function(t) {
          ...
          this.each(function(t, o) {
              if (e(o).is("table") && e(o).children().length == 1 && e(o).children().is("tbody"))
              ...
              var u = {
                  ...
                  container: o,
                  init: function() {
                      n.tagName = e(this.container).children().length == 0 ? "li" : e(this.container).children().get(0).tagName.toLowerCase();
                      if (n.itemSelector == "")
                  ...
                  grabItem: function(t) {
                      ...
                      if (t.which != 1 || e(t.target).is(n.dragSelectorExclude) || e(t.target).closest(n.dragSelectorExclude).length > 0 || !o)
                          return;
                      t.preventDefault();
                      var u = t.target;
                  ...
                  dragStart: function(t) {
                      ...
                      if (!n.dragBetween) {
                          var u = e(i.container).outerHeight() == 0 ?
                                Math.max(1, Math.round(.5 + i.getItems().length * i.draggedItem.outerWidth() / e(i.container).outerWidth())) * i.draggedItem.outerHeight()
                                : e(i.container).outerHeight();
                      ...
                      if (n.tagName == "tr") {
                          i.draggedItem.children().each(function() { e(this).width(e(this).width()) });
                          ...
                          i.placeHolderItem = i.draggedItem.next().css({ height: a, width: f }).attr("data-placeholder", true);
                      }
                      if (n.tagName == "td") {
